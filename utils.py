...
function setExposureTime(val)
    local hts = 1056
    local pixel_clock = 107000000
    local time_per_line = hts / pixel_clock *1e9
...
REG = 0x3632, 0x56
REG = 0x3633, 0x78
REG = 0x3662, 0x05  //1lane RAW10: 0x01, 1lane RAW8: 0x03, 2lane RAW10: 0x05
REG = 0x3666, 0x00
REG = 0x366f, 0x5a
REG = 0x3680, 0x84
REG = 0x3712, 0x80
