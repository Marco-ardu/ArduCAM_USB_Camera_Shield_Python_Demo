...
;**************************************************************************************/
[board parameter]
VRCMD = 0xD7, 0x4600, 0x0100, 1, 0x40
...
REG = 0xff, 0x01 
REG = 0x11, 0x01 
REG = 0x12, 0x00  // Bit[6:4]: Resolution selection//0x02为彩条
REG = 0x17, 0x11  // HREFST[10:3]
REG = 0x18, 0x75  // HREFEND[10:3]
REG = 0x32, 0x36  // Bit[5:3]: HREFEND[2:0]; Bit[2:0]: HREFST[2:0]
REG = 0x19, 0x01  // VSTRT[9:2]
REG = 0x1a, 0x97  // VEND[9:2]
REG = 0x03, 0x0f  // Bit[3:2]: VEND[1:0]; Bit[1:0]: VSTRT[1:0]
REG = 0x37, 0x40 
REG = 0x4f, 0xbb 
REG = 0x50, 0x9c 
REG = 0x5a, 0x57 
...
REG = 0x5a, 0x90                                    
REG = 0x5b, 0x2C                                    
REG = 0x5c, 0x05               //bit2->1;bit[1:0]->1
REG = 0xd3, 0x08                                    
REG = 0xe0, 0x00       
...
def DetectI2c(camera):
    ...
    if camera is not None:
        ...
        ret, value_hi = ArducamSDK.Py_ArduCam_readReg_8_8(camera.handle, camera.I2cAddr, 0x300A)
        ret, value_lo = ArducamSDK.Py_ArduCam_readReg_8_8(camera.handle, camera.I2cAddr, 0x300B)
    return value_hi == 0x26 and value_lo == 0x42
